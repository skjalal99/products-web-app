...
if ($res04 == true) {
    while ($row04 = $res04->fetch_assoc()) {
        $size_s = $row04['sizes']; ?>
       <div class="row">
    <div class="col-md-12 ml-2 " id="w10"><h3 class="sub-title text-left"><?php echo $size_s; ?> </h3><div class="sub-title-border"></div></div>
    ...
    <?php
        ...
        $res02 =  $conn->query($sql02) or die(mysqli_error());
        if ($res02 == true) {
