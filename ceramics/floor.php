...
<?php
          $sql01 =  "SELECT * FROM CATEGORIES where type='Floor'";
...
<?php
 ...
 AND categories.type = 'FLOOR' ORDER BY SIZES ASC";
...
if ($res04 == true) {
    ...
    <?php
                ...
                JOIN categories ON categories.id = tiles.categories_id) WHERE categories.type='FLOOR'
